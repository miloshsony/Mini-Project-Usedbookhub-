...
<html lang="en">
<head>
   <!-- Add this JavaScript code within the head tag of your HTML document -->
<script>
   function validateForm() {
      var name = document.forms["checkoutForm"]["name"].value;
      var number = document.forms["checkoutForm"]["number"].value;
      var pinCode = document.forms["checkoutForm"]["pin_code"].value;
...
<section class="checkout">
   ...
   <form action="" method="post" onsubmit="return validateForm()" name="checkoutForm">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" required placeholder="e.g. kottayam">
         </div>
         <div class="inputBox">
            <span>state :</span>
