...
// Check for the form submission to add a new product
if (isset($_POST['add_product'])) {
    ...
    if (mysqli_num_rows($select_product_name) > 0) {
        ...
        $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image, genre, description, author, cust_id) VALUES('$name', '$price', '$image', '$genre', '$description', '$author', '$cust_id')") or die('Query failed');
...
// Check for the product deletion
...
// Check for the form submission to update an existing product
...
<input type="text" name="update_author" value="<?php echo $fetch_update['author']; ?>" class="box" required placeholder="enter author">
